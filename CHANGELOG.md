...
- **旧域名迁移提示**：删除 `unikorn.axfff.com` 中已过时的校园网 / VPN 中英文限制说明，保留学校新站链接和 10 秒自动跳转。Removed the outdated campus-network / VPN restriction notice in both languages; the destination and 10-second redirect remain unchanged.
