...
describe('scheduler popularity UI contract', () => {
  ...
  it('shows privacy-protected course-level counts in course cards only', () => {
    ...
    expect(courseCard).toContain("course.enabled && course.selection_policy?.kind === 'module'")
    expect(courseCard).toContain('v-else-if="course.enabled" class="course-card__bundles"')
