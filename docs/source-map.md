...
| Announcements | [public pages](../pages/announcements), [home cards](../components/home/AnnouncementCardGrid.vue), [admin page](../pages/admin/announcements.vue) | [loader](../composables/useAnnouncements.ts), [historical archive](../data/announcementArchive.ts) | Backend `tests/test_announcement_posts.py` |
| Course overview/graph and retired review redirects | [courses](../pages/courses), [course components](../components/courses) | [overview](../composables/useCourseOverview.ts), [offering](../utils/courseOffering.ts), [detail](../utils/courseOverviewDetail.ts) | [courses](../tests/courses) |
...
| Notifications/PWA | [notifications](../pages/notifications.vue), [PWA components](../components/pwa) | [notifications](../composables/useNotifications.ts), [push](../composables/usePushNotifications.ts), [automatic updates](../utils/frontendUpdate.ts), [plugin](../plugins/pwa.client.ts), [worker](../public/sw.js), [build stamping](../utils/serviceWorkerBuild.ts) | [PWA](../tests/pwa), [health](../tests/server/health.test.ts); browser permissions/update/delivery checks plus backend tests |
